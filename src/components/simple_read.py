...
class SimpleReadPage:
    ...
    def _create_simple_read_page(self):
        ...
        with st.form("show_subset_sales_data"):
            ...
            col1.selectbox("Sales Year", [2019], key="sales_year")
            col2.selectbox("Sales Month", months, key="sales_month")

            "--------"

            st.number_input("Number of sales", min_value=10, format="%i", step=10, key="sales_subset_size")
